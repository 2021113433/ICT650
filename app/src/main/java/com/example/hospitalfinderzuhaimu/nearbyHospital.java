...
public class nearbyHospital extends FragmentActivity implements OnMapReadyCallback,
    ...
    String e1,e2,e3,keys, email;
    int PROXIMITY_RADIUS = 10000;
    double latitude,longitude;
    //ZUL TAMBAH
    DatabaseReference userdb= FirebaseDatabase.getInstance("https://hospital-finder-zuhaimu-d4772-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference("Locations");
    //ZUL TAMBAH
    ...
    public void onLocationChanged(Location location) {
        ...
        userdb.push().setValue(mLocations);
        options.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE));
        currentLocationmMarker = mMap.addMarker(options);
